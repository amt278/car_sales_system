...
public class Signup {
	...
	static {
		users.add(new User("adham mohamed", "0123456789123", "20191700086", "male", "adham", "123"));
		users.add(new User("osama anter", "01116741831", "20191700091", "male", "osama", "123"));
		users.add(new User("ahmed ibrahim", "01124602388", "20191700080", "male", "ahmed", "123"));
	}
	...
	public static void check() {
		...
		if ("".equals(t_name.getText())) {
			PopUp.alert("Please Enter Your Name");
		} else if ("".equals(t_uname.getText())) {
			PopUp.alert("Please Enter Your Username");
		} else if ("".equals(password.getText())) {
			PopUp.alert("Please Enter Your password");
		} else if (password.getText().length() < 8) {
			PopUp.alert("invalid password Please Enter password at least 8 characters ");
		} else if (t_phonenumber.getText().length() != 11) {
			PopUp.alert("Please Enter Valid number from 11 numbers");
		} else if (t_id.getText().length() != 14) {
			PopUp.alert("Please Enter Valid ID from 14 numbers");
		} else if (male.isSelected() == false && female.isSelected() == false) {
			PopUp.alert("please Choose Your Gender");
		} else {
			User user = new User();
