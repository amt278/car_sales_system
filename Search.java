...
public class Search {
	...
	public Scene return_scene() {
		...
		if (scene == null) {
			...
			// Buttons
			ImageView search = new ImageView(new Image(getClass().getResourceAsStream("buy.png")));
			search.setFitHeight(30);
			search.setFitWidth(30);
			Button btnBuy = new Button(" Buy", search);
	...
	public void search_item() {
		if (name.isSelected() == false && model.isSelected() == false && cost.isSelected() == false) {
			PopUp.alert("please select Your choose field");
